...
export function CtaBand({
  ...
  image = 'https://images.unsplash.com/photo-1502161254066-6c74afbf07aa?auto=format&fit=crop&w=2000&q=80',
      ...
      <div className="container relative z-10 py-24 lg:py-36">
        <div className="max-w-2xl">
          ...
          <Reveal delay={0.25} className="mt-9 flex flex-wrap gap-4">
            <Button href={primary.href} size="lg" arrow magnetic>
              {primary.label}
            </Button>
            {secondary && (
            ...
            {tertiary && (
              <Button href={tertiary.href} variant="ghost" size="lg">
                {tertiary.label}
              </Button>
            )}
          </Reveal>
