...
export const megaMenu: NavGroup[] = [
  ...
  },
  {
    ...
    links: [
      ...
      { label: 'UB Drip Merch', href: '/fomo-zone#merch', description: 'Wear the brand' },
  ...
  },
  {
    ...
    links: [
      ...
      { label: 'Meet the Team', href: '/staff', description: '6 branches of experts' },
...
export const footerGroups: NavGroup[] = [
  ...
  },
  {
    ...
    links: [
      ...
      { label: 'UB Drip Merch', href: '/fomo-zone#merch' },
